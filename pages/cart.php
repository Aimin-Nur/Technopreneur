...
<html lang="en">
  <head>
    <title>Lunette Scarves &mdash; Colorlib e-Commerce Template</title>
    <meta charset="utf-8">
            ...
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <h2 type="hidden" class="h5 text-black"><?$data['kode_produk']?></h2>

                  <tr>
                  <td><?= $no++ ?></td>
                    <td class="product-thumbnail">
                      <img src="gambar_produk/<?php echo $data['gambar_produk'];?>" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black"><?= $data['nama_produk']?></h2>
                    </td>
                    <td>Rp. <?php echo number_format($data['harga'])?></td>
                    <td>
                    <div class="col-md-12">
                    <span class="text-black"><?= $data['qty']?> Qty</span>
                    </div>
                    ...
                    <td><button name="delete" type="submit" class="btn btn-primary btn-sm">X</button></td>
                    </form>
                    <?php if (isset($_POST['delete'])) {
                                //persiapan Hapus Data
                                $hapus = mysqli_query($koneksi, "DELETE FROM keranjang WHERE kode_produk =  '$_POST[kode_produk]' ");
                                //jika Hapus sukses
                                if ($hapus) {
                                    echo "<script>
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black"><b>Rp. <?php echo $total ?></b></strong>
                    <?php ?>
                  </div>
                </div>
                <div class="row mb-5">
